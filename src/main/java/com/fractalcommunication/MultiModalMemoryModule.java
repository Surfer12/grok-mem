...
public class MultiModalMemoryModule implements IMemoryModule {
  ...
  private final Map<String, String> sessionMemory =
      new HashMap<>(); // userId_sessionId -> exerciseData
  ...
  public IUserProfile loadUserProfile(String userId) throws FCFException {
    return profiles.computeIfAbsent(
        ...
        k ->
            new UserProfileImpl(
                userId, Map.of("style", "fractal"), java.util.List.of("connection")));
  }

  @Override
  public void saveShortTermInteraction(String userId, String data, String sessionId)
      throws FCFException {
  ...
  @Override
  public void saveLongTermInteractionStyle(String userId, Map<String, String> styleData)
      throws FCFException {
  ...
  @Override
  public void saveSessionMemory(String userId, String sessionId, String exerciseData)
      throws FCFException {
    sessionMemory.put(userId + "_" + sessionId, exerciseData);
  }

  @Override
  public Optional<String> retrieveShortTermInteraction(String userId, String sessionId)
      throws FCFException {
