...
public class ConversationStateImplTest {
  ...
  public void testGetUserInput() {
    assertEquals(
        "Test input", state.getUserInput(), "User input should match the initialized value.");
  }
  ...
  public void testGetContext() {
    ...
    assertEquals(
        "Context 1", context.get(0), "Context content should match the initialized value.");
    assertNotSame(
        context,
        state.getContext(),
        "Context should return a copy to prevent modification of internal state.");
  }

  @Test
  public void testGetUserProfile() {
    assertEquals(
        profile, state.getUserProfile(), "User profile should match the initialized value.");
  }
  ...
  public void testGetHistory() {
    ...
    assertNotSame(
        history,
        state.getHistory(),
        "History should return a copy to prevent modification of internal state.");
  }
  ...
  public void testUpdateHistory() {
    ...
    assertEquals(
        initialHistory.size() + 1, history.size(), "Update should modify the history size.");
  }
}
