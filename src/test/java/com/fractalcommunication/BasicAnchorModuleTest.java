...
public class BasicAnchorModuleTest {
    ...
    public void testSelectAnchor() throws FCFException {
        ...
        assertTrue(selectedAnchor.getName().equals("Grounding") || selectedAnchor.getName().equals("Openness") || selectedAnchor.getName().equals("Connection"), "Selected anchor should be one of the default anchors.");
    }
    ...
    public void testApplyAnchor_UnsafeContext() {
        ...
        assertThrows(FCFException.class, () -> anchorModule.applyAnchor(reflection, anchor), "Unsafe context should throw FCFException.");
    }
    ...
    public void testGetAnchorSelectionMetrics() throws FCFException {
        ...
        assertEquals(1, metrics.get("selectionCount"), "Selection count should be incremented after selectAnchor.");
        assertEquals(0, metrics.get("successfulApplications"), "Successful applications should be 0 before applyAnchor.");
        ...
        assertEquals(1, metrics.get("successfulApplications"), "Successful applications should be incremented after applyAnchor.");
    }
}