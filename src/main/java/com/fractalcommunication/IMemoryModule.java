...
public interface IMemoryModule {
  ...
  void saveLongTermInteractionStyle(String userId, Map<String, String> styleData)
      throws FCFException;

  void saveSessionMemory(String userId, String sessionId, String exerciseData) throws FCFException;

  Optional<String> retrieveShortTermInteraction(String userId, String sessionId)
      throws FCFException;
