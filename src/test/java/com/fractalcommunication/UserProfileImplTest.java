...
public class UserProfileImplTest {
  ...
  public void setUp() {
    userProfile =
        new UserProfileImpl(
            "user123", Map.of("style", "fractal"), List.of("Grounding", "Connection"));
  }
  ...
  public void testGetInteractionStyle() {
    ...
    assertEquals(
        "fractal", style.get("style"), "Interaction style should match the initialized value.");
    assertNotSame(
        style,
        userProfile.getInteractionStyle(),
        "Interaction style should return a copy to prevent modification of internal state.");
  }
  ...
  public void testGetPreferredAnchors() {
    ...
    assertNotSame(
        anchors,
        userProfile.getPreferredAnchors(),
        "Preferred anchors should return a copy to prevent modification of internal state.");
  }
  ...
  public void testUpdateInteractionStyle() {
    ...
    assertEquals(
        "therapeutic", updatedStyle.get("mode"), "New interaction style entry should be added.");
  }
}
