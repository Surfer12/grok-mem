...
public interface IConversationOrchestrator {
    ...
    List<String> generateExercise(String challenge, String userId, String sessionId) throws FCFException;
    void handleInterruption(String userId, String sessionId, String reason) throws FCFException;
    void handleBranching(String userId, String sessionId, String branchType, String data) throws FCFException;
