...
public class BasicMetricsLoggerTest {
  ...
  public void testLogMetric() {
    ...
    assertEquals(
        1,
        metrics.get("TestModule_testMetric_count"),
        "Metric count should be 1 after logging a single metric.");
  }
  ...
  public void testLogMetric_MultipleValues() {
    ...
    assertEquals(
        2,
        metrics.get("TestModule_multiMetric_count"),
        "Metric count should be 2 after logging two values for the same metric.");
  }
  ...
  public void testLogError() {
    ...
    assertEquals(
        1,
        metrics.get("ErrorModule_error_count"),
        "Error count should be 1 after logging a single error.");
  }
  ...
  public void testLogError_WithCause() {
    ...
    assertEquals(
        1,
        metrics.get("ErrorModule_error_count"),
        "Error count should be 1 after logging an error with a cause.");
  }
  ...
  public void testGetAllMetrics_Mixed() {
    ...
    assertEquals(
        1,
        metrics.get("MixedModule_testMetric_count"),
        "Metric count should be 1 for logged metric.");
    assertEquals(
        1, metrics.get("MixedModule_error_count"), "Error count should be 1 for logged error.");
  }
}
