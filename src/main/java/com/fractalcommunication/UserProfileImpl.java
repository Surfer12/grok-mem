...
public class UserProfileImpl implements IUserProfile {
  ...
  public UserProfileImpl(
      String userId, Map<String, String> interactionStyle, List<String> preferredAnchors) {
    this.userId = userId;
  ...
  @Override
  public Map<String, String> getInteractionStyle() {
    return new HashMap<>(interactionStyle);
  }

  @Override
  public List<String> getPreferredAnchors() {
    return new ArrayList<>(preferredAnchors);
  }
