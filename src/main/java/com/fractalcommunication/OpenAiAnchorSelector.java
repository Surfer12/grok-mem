...
public class OpenAiAnchorSelector implements IMLAnchorSelector {
    ...
    public String selectAnchorWithML(IConversationState state, Map<String, ITherapeuticAnchor> availableAnchors) throws FCFException {
        ...
        messages.add(new ChatMessage(ChatMessageRole.SYSTEM.value(), "You are a helpful assistant for selecting therapeutic conversational strategies."));
        ...
        try {
            ...
            successCount++;
            System.out.println("OpenAI selected anchor: " + selectedAnchorName + " with rationale: " + responseText);
