...
public class BasicReflectionEngineTest {
    ...
    public void setUp() {
        ...
        state = new ConversationStateImpl("Test input", List.of("Context 1"), profile, new ArrayList<>());
    }
    ...
    public void testGetReflectionMetrics() {
        ...
        assertEquals(1, metrics.get("reflectionsPerformed"), "Reflections performed count should be 1 in metrics.");
    }
}